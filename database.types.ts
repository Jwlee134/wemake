...
export type Database = {
  public: {
    Tables: {
      ...
      notifications: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "notifications_receiver_id_profiles_profile_id_fk"
            columns: ["receiver_id"]
            isOneToOne: false
            referencedRelation: "community_post_detail_view"
            referencedColumns: ["author_id"]
      ...
      posts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "posts_topic_id_post_topics_topic_id_fk"
            columns: ["topic_id"]
            isOneToOne: false
            referencedRelation: "community_post_detail_view"
          ...
          },
          {
            ...
            columns: ["topic_id"]
            isOneToOne: false
            referencedRelation: "post_topics"
            referencedColumns: ["topic_id"]
          },
        ]
      }
    ...
    Enums: {
      event_type: "product_view" | "profile_view" | "product_visit"
      ...
      product_stages: "idea" | "prototype" | "mvp" | "launched"
      role:
        | "developer"
        | "designer"
        | "marketer"
