...
ALTER TABLE "notifications" ADD CONSTRAINT "notifications_receiver_id_profiles_profile_id_fk" FOREIGN KEY ("receiver_id") REFERENCES "public"."profiles"("profile_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
