...
CREATE TABLE "post_topics" (
	"topic_id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "post_topics_topic_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START WITH 1 CACHE 1),
	"name" text NOT NULL,
	"slug" text NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL
);
...
ALTER TABLE "post_replies" ADD CONSTRAINT "post_replies_profile_id_profiles_profile_id_fk" FOREIGN KEY ("profile_id") REFERENCES "public"."profiles"("profile_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "post_replies" ADD CONSTRAINT "post_replies_parent_reply_id_post_replies_reply_id_fk" FOREIGN KEY ("parent_reply_id") REFERENCES "public"."post_replies"("reply_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "posts" ADD CONSTRAINT "posts_topic_id_post_topics_topic_id_fk" FOREIGN KEY ("topic_id") REFERENCES "public"."post_topics"("topic_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
